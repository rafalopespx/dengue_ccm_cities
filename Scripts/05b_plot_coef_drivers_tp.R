...
ggsave(filename = "Outputs/Plots/rj/coef_precip_max_tp_17.png", 
...
ggsave(filename = "Outputs/Plots/rj/coef_precip_min_tp_17.png", 
...
ggsave(filename = "Outputs/Plots/rj/patchwork_coef_precip_tp_17.png",
...
ggsave(filename = "Outputs/Plots/rj/coef_precip_max_tp_52.png", 
...
ggsave(filename = "Outputs/Plots/rj/coef_precip_min_tp_52.png", 
...
ggsave(filename = "Outputs/Plots/rj/coef_precip_mean_tp_52.png", 
...
ggsave(filename = "Outputs/Plots/rj/patchwork_coef_precip_tp_52.png",
