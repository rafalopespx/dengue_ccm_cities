...
```{r rj-residuals-hist, echo=FALSE, message=FALSE, warning=FALSE, out.width=700, fig.align='center'}
knitr::include_graphics('img_v4/plot_hist_residuals.png')
```
---

```{r rj-surrogate-sample, echo=FALSE, message=FALSE, warning=FALSE, out.width=700, fig.align='center'}
knitr::include_graphics('img_v4/surrogate_sample_all_drivers.png')
```
